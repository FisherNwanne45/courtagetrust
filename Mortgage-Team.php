...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="width: 50%;">
                                            <h3><a id="Apply-Now"></a>Carolyn Belton</h3>
                                            <p>Loan Officer, Pascagoula<br>NMLS# 412106</p>
                                            <p><a href="mailto:CBelton@<?php echo $domain; ?>" class="Button1">EMAIL CAROLYN *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Carolyn</a></p>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 50%;">
                                            <h3>Billy R. Booth</h3>
                                            <p>Assistant Vice President/Branch Manager, Gautier<br>NMLS# 412107</p>
                                            <p><a href="mailto:BBooth@<?php echo $domain; ?>" class="Button1">EMAIL BILLY *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Billy</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 50%;">
                                            <h3>Tina Cochran</h3>
                                            <p>Vice President/Branch Manager, Hurley<br>NMLS# 412101</p>
                                            <p><a href="mailto:TCochran@<?php echo $domain; ?>" class="Button1">EMAIL TINA *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Tina</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 50%;">
                                            <h3>Adam Haygood</h3>
                                            <p>Loan Officer, Pascagoula<br>NMLS# 1616154</p>
                                            <p><a href="mailto:AHaygood@<?php echo $domain; ?>" class="Button1">EMAIL ADAM *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Adam</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="width: 50%;">
                                            <h3>Kristy Johnson</h3>
                                            <p>Assistant Vice President/Branch Manager, Vancleave<br>NMLS# 412108</p>
                                            <p><a href="mailto:KJohnson@<?php echo $domain; ?>" class="Button1">EMAIL KRISTY *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Kristy</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 50%;">
                                            ...
                                            <p>Vice President/Branch Manager, Moss Point<br>NMLS# 852010</p>
                                            <p><a href="mailto:RPerkins@<?php echo $domain; ?>" class="Button1">EMAIL RICHARD *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Richard</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 50%;">
                                            <h3>Leigh Rayburn</h3>
                                            <p>Loan Officer, Hurley<br>NMLS#&nbsp;1841604</p>
                                            <p><a href="mailto:lrayburn@<?php echo $domain; ?>" class="Button1">EMAIL Leigh *</a>&nbsp;<a href="opening.php" class="Button2">APPLY WITH LEIGH</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 50%;">
                                            <h3>Teresa Tanner</h3>
                                            <p>Vice President/Branch Manager, Ocean Springs<br>NMLS# 412105</p>
                                            <p><a href="mailto:TTanner@<?php echo $domain; ?>" class="Button1">EMAIL TERESA *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Teresa</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="width: 50%;">
                                            <h3>Samuel Stauter</h3>
                                            <p>Assistant Vice President/Assistant Branch Manager, Ocean Springs<br>NMLS# 1234899</p>
                                            <p><a href="mailto:SStauter@<?php echo $domain; ?>" class="Button1">EMAIL SAM *</a>&nbsp;<a href="opening.php" class="Button2">Apply With Sam</a></p>
                                            <p class="Phone"> <?php echo $phone; ?></p>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <table style="width: 100%;" class="Subsection-Table">
                <tbody>
                    <tr>
                        <td>
                            <p class="Disclaimer">*Please do not submit personal, confidential or account information via email.</p>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<!-- /Mortgage-Team by ], Wed, 25 Nov 2020 05:01:18 GMT -->
