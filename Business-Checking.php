...
<!-- /Business-Checking by ], Wed, 25 Nov 2020 05:01:32 GMT -->
...
<head>
    ...
    <title>Business Checking | <?php echo $name; ?> <?php echo $country; ?></title>
    <meta name="description" content="Business Checking | <?php echo $name; ?> <?php echo $country; ?>">
...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
            <table class="Subsection-Table" style="background-image: url('ContentImageHandlereae3.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 60%;">
                                            <h1>Business Checking Account</h1>
                                            <h2>A checking account for the small businesses we're proud to serve.</h2>
                                            <p>&nbsp;</p>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                        ...
                        <td>
                            <table class="Table-Account" style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h3>First Business Checking</h3>
                                            <p>Keep more of the money you make with First Business Checking!</p>
                                        </td>
                                        <td>
                                            <ul>
                                                <li>NO PER-ITEM FEES</li>
                                                <li><?php echo $curr; ?>100 minimum balance&nbsp;to open</li>
                                                <li>No minimum balance to maintain account</li>
                                                <li><?php echo $curr; ?>5.00 per month service charge</li>
                                            </ul>
                                        </td>
                                    </tr>
                                </tbody>
...
<!-- /Business-Checking by ], Wed, 25 Nov 2020 05:01:34 GMT -->
