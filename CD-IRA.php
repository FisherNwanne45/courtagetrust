...
<head>
    ...
    <title>CDs & IRAs | <?php echo $name; ?> (GB)</title>
    <meta name="description" content="CDs & IRAs | <?php echo $name; ?> (GB)">
...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
            <table class="Subsection-Table" style="background-image: url('ContentImageHandler09a8.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
                            ...
                            <table class="Table-Account" style="width: 100%;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                <li>$100,000 minimum balance to open</li>
                                                <li>Term 6 months to 8 years</li>
            ...
            <table class="Subsection-Table" style="background-image: url('ContentImageHandlerdcf5.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
