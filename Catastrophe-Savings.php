...
<head>
    ...
    <title>Catastrophe Savings Account | <?php echo $name; ?> <?php echo $country; ?></title>
    <meta name="description" content="Catastrophe Savings Account | <?php echo $name; ?> <?php echo $country; ?>">
...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
            <table class="Subsection-Table" style="background-image: url('ContentImageHandlerc99a.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                    <tr>
                                        <td width="50%">
                                            <h1>Catastrophe Savings Account</h1>
...
<!-- /Catastrophe-Savings by ], Wed, 25 Nov 2020 05:01:27 GMT -->
