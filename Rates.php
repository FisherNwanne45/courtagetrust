...
<!-- /Rates by ], Wed, 25 Nov 2020 05:01:34 GMT -->
...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
            <table class="Subsection-Table" style="background-image: url('ContentImageHandler8e54.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 50%;">
                                            <h1>Rates</h1>
                                            <ul>
                                                <li><a href="#Checking">Checking Rates</a></li>
                                                <li><a href="#Savings">Savings Rates</a></li>
                                                <li><a href="#CD">Certificate of Deposit Rates</a></li>
                                                <li><a href="#Jumbo-CD">Jumbo Certificate of Deposit Rates</a></li>
                        ...
                        <td>
                            <table class="Table-Grid">
                                <tbody>
                                    <tr>
                                        <td>
                                            <p class="Circle-Icon-Wallet"><span class="visuallyhidden">Wallet Icon</span></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left;">
                                            <h3>CD Special</h3>
                                            <p>19 Month&nbsp;Smart Rate at 0.30% APY</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><a class="Button1" href="CD-IRA.php">Learn More </a></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        <td>
                            <table class="Table-Style" style="width: 100%;">
                                <caption><a id="Checking"></a>Checking Account Rates</caption>
                                <thead>
                                    <tr>
                                        <th style="width: 25%;">Account</th>
                                        <th style="width: 18.75%;">APY</th>
                                        <th style="width: 18.75%;">Min. Bal. to Open</th>
                                        <th style="width: 18.75%;">Min. Bal. to Earn APY</th>
                                        <th style="width: 18.75%;">Interest</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                            ...
                            <table class="Table-Style" style="width: 100%;">
                                <caption><a id="Savings"></a>Savings Account Rates</caption>
                                <thead>
                                    <tr>
                                        <th style="width: 25%;">Account</th>
                                        <th style="width: 18.75%;">APY</th>
                            ...
                            <table class="Table-Style" style="width: 100%;">
                                <caption><a id="CD"></a>Certificate of Deposit Rates*</caption>
                                <thead>
                                    <tr>
                                        <th style="width: 33%;">Account</th>
                                        <th style="width: 33%;">APY</th>
                                        <th style="width: 33%;">Interest</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>6 Year CD - LIMITED OFFER</td>
                                        <td>0.70%</td>
                                        <td>0.70%</td>
                                    </tr>
                                    <tr>
                                        <td>8 Year CD - LIMITED OFFER</td>
                                        <td>1.00%</td>
                                        <td>1.00%</td>
                                    </tr>
                                    <tr>
                                        <td>19 Month Smart Rate CD</td>
                                        <td>0.30%</td>
                                        <td>0.30%</td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="Table-Style" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>6 Month Jumbo CD</td>
                                        <td>0.20%</td>
                                        <td>0.20%</td>
                                    </tr>
                                    <tr>
                                        <td>1 Year Jumbo CD</td>
                                        <td>0.30%</td>
                                        <td>0.30%</td>
                                    </tr>
                                    <tr>
                                        <td>2 Year Jumbo CD</td>
                                        <td>0.45%</td>
                                        <td>0.45%</td>
                                    </tr>
                                    <tr>
                                        <td>3 Year Jumbo CD</td>
                                        <td>0.50%</td>
                                        <td>0.50%</td>
                                    </tr>
                                    <tr>
                                        <td>5 Year Jumbo CD</td>
                                        <td>0.70%</td>
                                        <td>0.70%</td>
                                    </tr>
                                    <tr>
                                        <td>8 Year Jumbo CD</td>
                                        <td>1.10%</td>
                                        <td>1.09%</td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="Table-Style" style="width: 100%;">
                                ...
                                <caption><a id="IRA"></a>IRA Rates</caption>
                                <tbody>
                                    <tr>
...
<!-- /Rates by ], Wed, 25 Nov 2020 05:01:36 GMT -->
