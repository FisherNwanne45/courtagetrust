                    ...
                    <form method="POST">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="text" required autocomplete="off" class="form-control" name="account_number"
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="text" required maxlength="11" autocomplete="off" class="form-control"
                                    name="swift_code" placeholder="KJHG8XXXX">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="text" required maxlength="11" autocomplete="off" class="form-control"
                                    name="routine_number" placeholder="87654345678XXX">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="amount" class="form-control" name="amount"
                                    placeholder="You will be charged a fee of <?= $row['acct_currency'] ?><?= $page['wirefee'] ?>"
                                    disabled>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <button type="submit" class="btn btn-lg btn-primary btn-block"
                                        name="wire-transfer">Proceed</button>
                                </div>
                            </div>
                        </div>
