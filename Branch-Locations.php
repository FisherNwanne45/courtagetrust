...
<html lang="en">
    ...
    <!-- /Branch-Locations by ], Wed, 25 Nov 2020 05:00:00 GMT -->
    ...
    <head>
        ...
        <title>Branch Locations | <?php echo $name; ?> <?php echo $country; ?> </title>
        <meta name="description" content="Branch Locations <?php echo $name; ?>, <?php echo $country; ?>
">
        <meta name="keywords" content="Branch, Locations, <?php echo $name; ?>, <?php echo $country; ?>
">
    </head>
    ...
    -->
        <div class="page">
            ...
            <main>
                <table class="Subsection-Table" style="background-image: url('ContentImageHandlera63b.jpg');">
                    <tbody>
                        <tr>
                            <td>
                                <table>
                ...
                <table class="Subsection-Table">
                    <tbody>
                        <tr>
                            <td>
                                <p style="text-align: center;"><span style="font-size: 18pt;"><strong>Our Banking Hours
                                            Are:</strong></span><br><span style="font-size: 18pt;">Monday, Tuesday &amp;
                                        Thursday 9:00 am - 4:00 pm</span><br><span style="font-size: 18pt;">Wednesday
                                        9:00 am - 12:00 pm </span><br><span style="font-size: 18pt;">Friday 9:00 am -
                                        5:00 pm</span></p>
                                <h2> <?php echo $country; ?> - Head Office</h2>
                                <table width="100%" class="Table-Location">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p><img src="office1.jpg" alt="Location Pascagoula" border="0"></p>
                                                <p><?php echo $officer; ?></p>
                                            </td>
                                            <td>
                                                <?php if (!empty($addr)): ?> <p> <?php echo $addr; ?>
                                                    <br><?php endif; ?>
                                                    <?php if (!empty($country)): ?> <?php echo $country; ?>
                                                </p>
                                                <?php endif; ?>
                                                <p><a href="#speedbumpa27f.php?link=https://goo.gl/maps/gtoAusjjnQ62"
                                                        class="Button1">Directions</a></p>
                                            </td>
                                            <td>
                                                <?php if (!empty($phone)): ?> <p>Telephone: <?php echo $phone; ?></p>
                                                <?php endif; ?>
                                                <?php if (!empty($email)): ?> <p>Email: <?php echo $email; ?></p>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    </tbody>
                ...
                <?php if (!empty($country2) || !empty($addr2) || !empty($phone2)): ?>
                <table class="Subsection-Table">
                    <tbody>
                        <tr>
                            <td>
                                <h2><?php echo $country2; ?></h2>
                                <table width="100%" class="Table-Location">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>
                                                    <img src="office2.jpg" alt="Location Vancleave" border="0">
                                                </p>
                                                <p><?php echo $officer2; ?></p>
                                            </td>
                                            <td>
                                                <?php if (!empty($addr2)): ?> <p><?php echo $addr2; ?></p>
                                                <?php endif; ?>
                                                <p>
                                                    <a href="#speedbump9d00.php?link=https://goo.gl/maps/cRGv2RtYhHN2"
                                                        class="Button1">Directions</a>
                                                </p>
                                            </td>
                                            <td>
                                                <?php if (!empty($phone2)): ?> <p>Toll Free: <?php echo $phone2; ?></p>
                                                <?php endif; ?>
                                                <?php if (!empty($email2)): ?> <p>Email: <?php echo $email2; ?></p>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    </tbody>
                ...
                <?php endif; ?>
                <?php if (!empty($country3) || !empty($addr3) || !empty($phone3)): ?>
                <table class="Subsection-Table">
                    <tbody>
                        <tr>
                            <td>
                                <h2><?php echo $country3; ?></h2>
                                <table width="100%" class="Table-Location">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>
                                                    <img src="office3.jpg" alt="Location Vancleave" border="0">
                                                </p>
                                                <p><?php echo $officer3; ?></p>
                                            </td>
                                            <td>
                                                <?php if (!empty($addr3)): ?> <p><?php echo $addr3; ?></p>
                                                <?php endif; ?>
                                                <p>
                                                    <a href="#speedbump9d00.php?link=https://goo.gl/maps/cRGv2RtYhHN2"
                                                        class="Button1">Directions</a>
                                            ...
                                            <td>
                                                <?php if (!empty($phone3)): ?> <p>Toll Free: <?php echo $phone3; ?></p>
                                                <?php endif; ?>
                                                <?php if (!empty($email3)): ?> <p>Email: <?php echo $email3; ?></p>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    <!-- /Branch-Locations by ], Wed, 25 Nov 2020 05:00:30 GMT -->
