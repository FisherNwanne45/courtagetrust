...
<head>
    ...
    <title>Contact Us | <?php echo $name; ?>)</title>
    <meta name="description" content="Contact Us <?php echo $name; ?>, <?php echo $country; ?>">
    <meta name="keywords" content="Contact Us <?php echo $name; ?>, <?php echo $country; ?>">
</head>
...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
            <table class="Subsection-Table" style="background-image: url('ContentImageHandler0a5c.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
