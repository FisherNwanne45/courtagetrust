...
<!-- /Refinance-Equity by ], Wed, 25 Nov 2020 05:03:40 GMT -->
                        ...
                        <td>
                            <table>
                                <tbody>
                                    <tr>
                                        <td width="50%">
                                            <h1>Refinance &amp; Home Equity Options</h1>
                    ...
                    <tr>
                        <td>
                            ...
                            <ul>
                                ...
                                <li>Resolve financial burdens</li>
                            </ul>
                            <h2><a id="HELOC"></a>Second Mortgage</h2>
                            <p>A second mortgage is a loan you make using the equity in your home, in addition to your first mortgage.&nbsp; We offer a Fixed Rate Equity Loan and a Home Equity Line of Credit (HELOC).</p>
                            <h3 style="padding-left: 30px;">Fixed Rate Equity Loan</h3>
                            <p style="padding-left: 30px;">With a Fixed Rate Equity Loan, you have a fixed rate, term and monthly payment for the life of your loan. You get the money up front to consolidate bills, make improvements on your home or pay for college. You are protected from rising interest rates and may even be able to deduct the interest from your income taxes.</p>
                            <h3 style="padding-left: 30px;">HELOC</h3>
                            <p style="padding-left: 30px;">Another great option for consolidating debt or remodeling is a Home Equity Line of Credit (HELOC).&nbsp; A HELOC is a&nbsp;revolving line of credit without a fixed rate.&nbsp;&nbsp;The borrower does not have to use the entire loan amount up front.&nbsp; Instead, you can borrow against it as needed, much like a credit card.&nbsp; The line of credit is available for 5 years, with repayment terms up to 10 years, making monthly payments affordable.&nbsp;</p>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<!-- /Refinance-Equity by ], Wed, 25 Nov 2020 05:03:43 GMT -->
