        ...
        <main>
            ...
            <table class="Subsection-Table">
                <tbody>
                    <tr>
                        <td>
                            <p style="text-align: center;"><span style="font-size: 18pt;"><strong>Our Banking Hours Are:</strong></span><br><span style="font-size: 18pt;">Monday, Tuesday &amp; Thursday 9:00 am - 4:00 pm</span><br><span style="font-size: 18pt;">Wednesday 9:00 am - 12:00 pm </span><br><span style="font-size: 18pt;">Friday 9:00 am - 5:00 pm</span></p>
                            <h2> <?php echo $country; ?> - Head Office</h2>
                            <table width="100%" class="Table-Location">
                                <tbody>
                                    <tr>
                                        <td>
                                            <p><img src="ContentImageHandler4641.jpg?ImageId=123610" alt="Location Pascagoula" border="0"></p>
                                            <p>Randy Haarala, Operations Officer</p>
                                        </td>
                                        <td>
                                            <p> <?php echo $addr; ?> <br>
                                                <?php echo $country; ?></p>
                                            <p><a href="speedbumpa27f.php?link=https://goo.gl/maps/gtoAusjjnQ62" class="Button1">Directions</a></p>
                                        </td>
                                        <td>
            ...
            <table class="Subsection-Table">
                <tbody>
                    <tr>
                        <td>
                            <h2>Vancleave Branch</h2>
                            <table width="100%" class="Table-Location">
                                <tbody>
                                    <tr>
                                        <td>
                                            <p><img src="ContentImageHandler480a.jpg?ImageId=123614" alt="Location Vancleave" border="0"></p>
                                            <p>Kristy Johnson, Branch Manager</p>
                                        </td>
                                        <td>
                                            <p>10900 Highway 57<br>P.O. Box 5397<br>Vancleave, MS 39565-5397</p>
                                            <p><a href="speedbump9d00.php?link=https://goo.gl/maps/cRGv2RtYhHN2" class="Button1">Directions</a></p>
                                        </td>
                                        <td>
                                            <p>Toll Free: <?php echo $phone; ?></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
