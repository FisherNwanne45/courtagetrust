...
<head>
    ...
    <title>Construction & Renovation | <?php echo $name; ?> <?php echo $country; ?></title>
    <meta name="description" content="Construction & Renovation | <?php echo $name; ?> <?php echo $country; ?>">
...
<body class="" id="top">
    ...
    <div class="page">
        ...
        <main>
            <table class="Subsection-Table" style="background-image: url('ContentImageHandlere8d5.jpg');">
                <tbody>
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 60%;">
                                            <h1>Construction&nbsp;</h1>
                                            <h3>Whether building from scratch or transforming a fixer-upper, one loan and one closing saves you time and money.</h3>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </tbody>
            ...
            <table class="Subsection-Table">
                <tbody>
                    <tr>
                        <td>
                            <h2>Construction-Permanent Home Loan</h2>
                            <p>With an outstanding reputation among builders and customers, we have the expertise to guide you through the process from application to completion.</p>
                            <ul class="List-Checkmark">
                                <li>Local decision making, processing and servicing for the life of your loan</li>
                                <li>One-time closing helps you save on closing costs</li>
                                <li>Up to 30 years financing available (Fixed Rate or Adjustable)</li>
                                <li>No pre-payment (early payoff) penalties</li>
                            </ul>
                            <h2><a id="Renovation"></a>Renovating Your Home</h2>
                            <p>Thinking of remodeling your home or buying a home that needs a face lift?&nbsp; With a Renovation Construction-Perm Loan, renovations are financed in conjunction with a new home purchase or refinance.</p>
                            <ul class="List-Checkmark">
                                <li>Local decision making, processing and servicing for the life of your loan</li>
                                <li>One-time closing helps you save on closing costs</li>
                                <li>Up to 30 years financing available (Fixed Rate or Adjustable)</li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="Mortgage-Team.php#Apply-Now" class="Grid-Button">Apply Now</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
...
<!-- /Construction by ], Wed, 25 Nov 2020 05:01:45 GMT -->
