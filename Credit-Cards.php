...
<head>
    ...
    <title>Credit Cards | <?php echo $name; ?> <?php echo $country; ?></title>
    <meta name="description" content="Credit Cards | <?php echo $name; ?> <?php echo $country; ?>">
        ...
        <main>
            ...
            <table class="Subsection-Table">
                <tbody>
                    <tr>
                        <td>
                            <h2>Personal Credit Card</h2>
                            <p>We make it easy to choose the credit card that is right for you - Low Rate or Preferred Points Rewards. It&rsquo;s the only card you need for everything you need to do.</p>
                            <h3>Personal Card &ndash; Low Rate</h3>
                            <h4>Features</h4>
                            <ul>
                                <li>No annual fee.</li>
                                <li>Low introductory rate for the first six months.<sup>1</sup></li>
                                <li>Competitive ongoing APR. <sup>1</sup></li>
                            ...
                            <ul>
                                ...
                                <li>Online account information available 24/7 at <a href="speedbumpb679.php?link=https://www.cardaccount.net/application/d2c11e4705/consumer/new">www.cardaccount.net</a>.</li>
                                <li>Rental car collision damage waiver protection and a host of extraordinary MasterCard&reg; benefits.</li>
                                <li>Unlike some card offers, the APR<sup>1</sup> for purchases and cash advances is the same. We do not charge a higher rate for cash advances.</li>
                            </ul>
                            <h4>Fees</h4>
                            <ul>
                                <li>Other fees may be charged, these fees are listed on the <a href="4645%20MC%2004%202020%20CON720e.pdf?documentId=58679" target="_blank">downloadable application</a>.</li>
                            </ul>
                            <h3>Personal Card &ndash;World / Preferred Points Rewards</h3>
                            <h4>Features</h4>
                            <ul>
                                <li>Earn points that you can redeem for rewards. Earn one point for each dollar spent, up to 10,000 points per month.</li>
                                <li>Low introductory rate for first six months.<sup> 1</sup></li>
                                <li>Competitive ongoing APR. <sup>1 </sup></li>
                                <li>No annual fee.</li>
                                <li>25-day interest-free grace period on all purchases. No grace period on cash advances.</li>
                            </ul>
                            <h4>Benefits</h4>
                            <ul>
                                <li>Redeem your rewards points for cash-back awards, retail gift cards, travel and a wide variety of merchandise including cameras, mp3 players, home theater systems, portable DVD players, sporting equipment, jewelry, luggage, electronics, video game equipment, gift cards and more. \</li>
                                <li>To view or redeem rewards points, visit <a href="speedbumpdc1a.php?link=http://www.mypreferredpoints.com">www.mypreferredpoints.com</a>&nbsp;or call 866-678-5191.</li>
                                <li>24-hour toll-free live customer assistance available at 800-367-7576.</li>
                                <li>Online account information available 24/7 at <a href="speedbumpb679.php?link=https://www.cardaccount.net/application/d2c11e4705/consumer/new">www.cardaccount.net</a>.&nbsp;</li>
                                <li>Rental car collision damage waiver protection and a host of extraordinary MasterCard benefits.</li>
                                <li>Unlike some card offers, the APR 1 for purchases and cash advances is the same. We do not charge a higher rate for cash advances.</li>
                            </ul>
                            <h4>Fees</h4>
                            <ul>
                                <li>Other fees may be charged, these fees are listed on the <a href="4645%20MC%2004%202020%20CON720e.pdf?documentId=58679" target="_blank">downloadable application</a>.</li>
                            ...
                            <h3>To Apply Now</h3>
                            <ul>
                                <li><a href="index.php">Log in to Home Banking</a>&nbsp;and follow the instructions to apply online, or</li>
                                <li>Download the <a href="4645%20MC%2004%202020%20CON720e.pdf?documentId=58679" target="_blank">PDF Application</a>.&nbsp;
                                    <ul>
                                        <li>Type the information and then print the application (you cannot save the document, so print an extra copy for yourself), or print it and then complete it using a blue or black pen. Paper applications are also available at our local branch office.</li>
                                        <li>Fax your completed application to the Card Service Center at 877-809-9162.</li>
                                    </ul>
                                </li>
                            </ul>
                            <p class="Disclaimer"><sup>1</sup> Please see application for information about current APRs and fees.<br><sup>2</sup> Concierge Services available with World MasterCard only.</p>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table class="Subsection-Table-Promo-Blue">
                <tbody>
                    <tr>
                        <td>
                            <h2>Extraordinary Benefits with MasterCard&reg;</h2>
                            <p>Concierge Service<sup>2</sup><br>Price Protection<br>Baggage Delay Insurance<br>Car Rental Collision Damage Waiver Insurance<br>Extended Warranty<br>Travel Assistance<br>Roadside Assistance<br>Purchase Assurance<br>Travel Accident Insurance</p>
                            <p class="Disclaimer">Certain restrictions apply detailed in the applicable benefits brochure received with new credit card.&nbsp;</p>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <p>Choose the card that is right for your business - Standard Card with no annual fee or the Preferred Points Rewards Card.</p>
                            <h3>Business Card &ndash; Standard Card</h3>
                            <h4>Features</h4>
                            <ul>
                                <li>No annual fee.</li>
                                <li>Competitive ongoing APR.<sup>1</sup></li>
                                <li>25-day interest-free grace period on all purchases. No grace period on cash advances.</li>
                                <li>Individual and summary billing options.</li>
                            </ul>
                            <h4>Benefits</h4>
                            <ul>
                                <li>24-hour toll-free live customer assistance available at 800-367-7576.</li>
                                <li>Online account information available 24/7 at <a href="speedbump1ece.php?link=https://www.cardaccount.net/application/d2c11e4705/business/new">www.cardaccount.net</a>.&nbsp;</li>
                                <li>Rental car collision damage waiver protection and a host of extraordinary MasterCard benefits.</li>
                            </ul>
                            <p>Fees</p>
                            <ul>
                                <li>Other fees may be charged, these fees are listed on the <a href="Business%20card%20application%202020a021.pdf?documentId=58680" target="_blank">downloadable application</a>.</li>
                            </ul>
                            <h3>Business Card &ndash; Preferred Points Rewards</h3>
                            <h4>Features</h4>
                            <ul>
                                <li>Earn one reward point for each dollar spent, up to 10,000 points per month.</li>
                                <li>Low annual fee of <?php echo $curr; ?>49.00 per account.</li>
                                <li>Competitive ongoing APR. <sup>1</sup></li>
                                <li>25-day interest-free grace period on all purchases. No grace period on cash advances.</li>
                                <li>Individual billing option only.</li>
                            </ul>
                            <h4>Benefits</h4>
                            <ul>
                                <li>Redeem your rewards points for cash-back awards, retail gift cards, travel and a wide variety of merchandise including cameras, mp3 players, home theater systems, portable DVD players, sporting equipment, jewelry, luggage, electronics, video game equipment, gift cards and more.</li>
                            ...
                            <ul>
                                <li><a href="index.php">Log in to Home Banking</a>&nbsp;and follow the instructions to apply online, or</li>
                                <li>Download the <a href="Business%20card%20application%202020a021.pdf?documentId=58680" target="_blank">PDF Application</a><span style="font-family: inherit; font-size: inherit;">.&nbsp;</span>
                                    <ul>
                                        <li>Type the information and then print the application (you cannot save the document, so print an extra copy for yourself), or print it and then complete it using a blue or black pen.</li>
                                        <li>Supporting documents vary depending on the type of business you have. See chart below.</li>
                                        <li>Fax your completed application to the Card Service Center at 877-809-9162.</li>
                                    </ul>
                                </li>
                            </ul>
                            <p class="Disclaimer" style="font-family: inherit; font-size: inherit;"><sup>1</sup> Please see application for information about current APRs and fees.</p>
                            <h4>Supporting Documents for Credit Card Application</h4>
...
<!-- /Credit-Cards by ], Wed, 25 Nov 2020 05:02:36 GMT -->
