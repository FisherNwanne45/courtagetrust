 ...
 <head>
     ...
     <meta name="description" content=" <?php echo $name; ?>, <?php echo $country; ?>">
     <meta name="keywords" content=" <?php echo $name; ?>, <?php echo $country; ?>">

 </head>

 <body class="home" id="top">
     <h1 class="visuallyhidden"> <?php echo $name; ?></h1>
             ...
             <div class="noticeHtml">
                 <table style="width: 100%;">
                     <tbody>
                         <tr>
                             <td>
                                 <p>For the health and safety of our customers and employees, please continue to use
                                     our Drive-Up Window service at all branches.&nbsp; Lobby visits by appointment
                                     only.&nbsp; Thank you.</p>
                             </td>
                         </tr>
                     </tbody>
     ...
     <div class="page">
                                 ...
                                 <div>
                                     ...
                                     <ul>
                                         ...
                                         <li><a href="Additional-Services.php#Telephone-Banking">Telephone
                                                 Banking</a></li>
                                         <li><a href="Additional-Services.php#Lost-Card">Lost or Stolen Card</a>
                                         </li>
                                     </ul>
                                 </div>
                             </div>
         ...
         <section id="hero-main">
             <div class="inner-content">
                 <div id="login" class="d10 animated bounceInRight">
                     <div id="login-inner">
                         <div id="login-content">
                             <strong style="color:red;">&nbsp;</strong>
                             <h2>Online Banking</h2>
                             <form method="POST" action="index.php" enctype="multipart/form-data" id="Remote">
                             ...
                             <div id="oblinks">
                                 <ul>
                                     <li><i class="fa-door"></i><a href="login.php">LOGIN</a></li>
                                     <li><i class="fa-edit"></i><a href="opening.php">Enroll</a></li>
                                 </ul>
                             </div>
                         </div>
                     </div>
             ...
             <div class="slideshow-control-bar">
                 <button id="previous" class="slideshow-previous"><i class="fa fa-backward"></i><span
                         class="visuallyhidden">Previous Slide</span></button>
                 <button id="play" class="slideshow-play"><i class="fa fa-play"></i><span
                         class="visuallyhidden">Play Slideshow</span></button>
                 <button id="pause" class="slideshow-pause"><i class="fa fa-pause"></i><span
                         class="visuallyhidden">Pause Slideshow</span></button>
                 <button id="next" class="slideshow-next"><i class="fa fa-forward"></i><span
                         class="visuallyhidden">Next Slide</span></button>
             </div>
             <!-- cms content here -->
                 ...
                 <ul class="nav2 group">
                     <li class="homenavitem">
                         <a href="javascript:void(0)" class="homenavdoor">
                             <i class="homeicon icon-wallet"></i>
                             <h2>Deposit <span>Accounts</span></h2>
                         </a>
                     ...
                     <li class="homenavitem">
                         <a href="javascript:void(0)" class="homenavdoor">
                             ...
                             <h2>Mortgage <span>Lending</span></h2>
                         </a>
                         <div class="homenavContent">
                     ...
                     <li class="homenavitem">
                         <a href="javascript:void(0)" class="homenavdoor">
                             <i class="homeicon icon-laptop"></i>
                             <h2>Account <span>Services</span></h2>
                         </a>
                         <div class="homenavContent">
                             ...
                             <ul>
                                 ...
                                 <li><a href="Online-Services.php#Mobile-Banking">Mobile Banking</a></li>
                                 <li><a href="Online-Services.php#Bill-Pay">Bill Pay</a></li>
                                 <li><a href="Online-Services.php#TransferNow">Transfer Now</a></li>
                                 <li><a href="Card-Services.php">Card Valet</a></li>
                                 <li><a href="Card-Services.php#Debit-Card">Photo Debit Card</a></li>
                     ...
                     <li class="homenavitem">
                         <a href="javascript:void(0)" class="homenavdoor">
                             <i class="homeicon icon-first-federal-logo"></i>
                         ...
                         <div class="homenavContent">
                             ...
                             <ul>
                                 ...
                                 <li><a href="Branch-Locations.php">Branch Locations</a></li>
                                 <li><a href="Our-Legacy.php">Our Legacy</a></li>
                                 <li><a href="We-Care.php">Why You're First With Us</a></li>
                             </ul>
                         </div>
                     </li>
                 </ul>
         ...
         <table class="Subsection-Table-Promo-White">
             <tbody>
                 <tr>
                     <td>
                         <h3>Our Legacy Continues...</h3>
                         <table style="width: 100%;" class="Table-Count-Numbers">
                             <tbody>
                                 <tr>
                                     <td>
                                         <p class="Number" style="text-align: center;"><span class="count">64</span>
                                         </p>
                                         <h3>Years</h3>
                                         <p>Serving Our Customers</p>
                                     </td>
                                     <td>
                                         <p class="Number"><span class="count">846</span></p>
                                         <h3>Million</h3>
                                         <p>In Home Loans since 2000</p>
                                     </td>
                                     <td>
                                         <p class="Number"><span class="count">18</span></p>
                                         <h3>Years</h3>
                                         <p>Average Employee Experience</p>
                                     </td>
                                 </tr>
                             </tbody>
                         </table>
                     ...
                     <td>
                         <table>
                             <tbody>
                                 <tr>
                                     <td>
                                         <h2>"We're by your side from foundation to finish."</h2>
                                         <p>-Richard Perkins, Assistant Vice President, Moss Point</p>
                                         <p><a class="Button1" href="Construction.php">Learn More</a></p>
                                     </td>
                                     <td>&nbsp;</td>
                                 </tr>
                             </tbody>
                     ...
                     <td>
                         <table class="Table-Grid">
                             <tbody>
                                 <tr>
                                     <td>
                                         <p class="Circle-Icon-Home"><span class="visuallyhidden">Home Icon</span>
                                         </p>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td style="text-align: left;">
                                         <h3>Start your Mortgage Application</h3>
                                         <p>Our mortgage process is simple and streamlined, just the way you want
                                             it.</p>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                         <p><a class="Button1" href="Mortgage-Team.php#Apply-Now"
         ...
         <table class="Subsection-Table-Promo-White">
             <tbody>
                 <tr>
                     <td>
                         <h3>We've made switching banks easy. Download our Switch Kit today!</h3>
                         <p><a class="Button1" href="fillable%20switchkit434d.pdf?documentId=57331"
                                 target="_blank">SWITCH NOW</a></p>
                     </td>
                 </tr>
             </tbody>
         </table>
     ...
     <script type="text/javascript">
         ...
         (function() {
             ...
             s1.async = true;
             s1.src = 'https://embed.tawk.to/63da3fad474251287910d6f7/1go68hg73';
             s1.charset = 'UTF-8';
